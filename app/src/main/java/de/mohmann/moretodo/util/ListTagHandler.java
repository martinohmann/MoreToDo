...
/*
 * Copyright (C) 2016 Martin Ohmann
...
public class ListTagHandler implements Html.TagHandler {
    ...
    final public static String TAG = "ListTagHandler";
    /**
    ...
    public void handleTag(boolean opening, String tag, Editable output, XMLReader xmlReader) {
        if (tag.equalsIgnoreCase("ul")) {
                ...
                if (lists.peek().equalsIgnoreCase("ul")) {
                    ...
                    if (lists.size() > 1) {
                        ...
                        if (lists.size() > 2) {
                            ...
                            // we must also counter it's effect to BulletSpan
            ...
            if (opening) Log.d(TAG, "Found an unsupported tag " + tag);
        }
    }
